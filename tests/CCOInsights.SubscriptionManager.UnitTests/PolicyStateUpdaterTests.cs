...
namespace CCOInsights.SubscriptionManager.UnitTests
{
    public class PolicyStateUpdaterTests
    {
        ...
        public async Task PolicyStateUpdater_UpdateAsync_ShouldUpdate_IfValid()
        {
            ...
            _storageMock.Verify(x => x.UpdateItemAsync(It.IsAny<string>(), It.Is<PolicyState>(x => x.SubscriptionId == subscriptionTest.SubscriptionId && x.TenantId == subscriptionTest.Inner.TenantId), It.IsAny<CancellationToken>()), Times.Once);
        }
    }
}
