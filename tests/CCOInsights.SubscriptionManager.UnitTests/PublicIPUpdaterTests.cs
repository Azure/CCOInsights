...
namespace CCOInsights.SubscriptionManager.UnitTests
{
    public class PublicIPUpdaterTests
    {
        ...
        public async Task PublicIPUpdater_UpdateAsync_ShouldUpdate_IfValid()
        {
            ...
            _storageMock.Verify(x => x.UpdateItemAsync(It.IsAny<string>(), It.Is<PublicIPs>(x => x.SubscriptionId == subscriptionTest.SubscriptionId && x.TenantId == subscriptionTest.Inner.TenantId), It.IsAny<CancellationToken>()), Times.Once);
        }
    }
}
