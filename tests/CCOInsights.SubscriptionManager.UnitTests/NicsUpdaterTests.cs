...
namespace CCOInsights.SubscriptionManager.UnitTests
{
    public class NicsUpdaterTests
    {
        ...
        public async Task NicsUpdater_UpdateAsync_ShouldUpdateNics_IfValid()
        {
            ...
            _storageMock.Verify(x => x.UpdateItemAsync(It.IsAny<string>(), It.Is<Nic>(x => x.SubscriptionId == subscriptionTest.SubscriptionId && x.TenantId == subscriptionTest.Inner.TenantId), It.IsAny<CancellationToken>()), Times.Once);
        }
