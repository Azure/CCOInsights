...
namespace CCOInsights.SubscriptionManager.UnitTests
{
    public class AppServicePlansUpdaterTests
    {
        ...
        public async Task BlueprintArtifactUpdater_UpdateAsync_ShouldUpdate_IfValid()
        {
            ...
            _storageMock.Verify(x => x.UpdateItemAsync(It.IsAny<string>(), It.Is<AppServicePlans>(x => x.SubscriptionId == subscriptionTest.SubscriptionId && x.TenantId == subscriptionTest.Inner.TenantId), It.IsAny<CancellationToken>()), Times.Once);
        }
    }
}
