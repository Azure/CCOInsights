...
namespace CCOInsights.SubscriptionManager.UnitTests
{
    public class DisksUpdaterTests
    {
        ...
        public async Task PricingUpdater_UpdateAsync_ShouldUpdate_IfValid()
        {
            ...
            _storageMock.Verify(x => x.UpdateItemAsync(It.IsAny<string>(), It.Is<Disks>(x => x.SubscriptionId == subscriptionTest.SubscriptionId && x.TenantId == subscriptionTest.Inner.TenantId), It.IsAny<CancellationToken>()), Times.Once);
        }
    }
}
