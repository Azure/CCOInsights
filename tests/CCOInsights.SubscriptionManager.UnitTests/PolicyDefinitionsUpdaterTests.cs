...
namespace CCOInsights.SubscriptionManager.UnitTests
{
    public class PolicyDefinitionsUpdaterTests
    {
        ...
        public async Task PolicyDefinitionsUpdater_UpdateAsync_ShouldUpdate_IfValid()
        {
            ...
            _storageMock.Verify(x => x.UpdateItemAsync(It.IsAny<string>(), It.Is<PolicyDefinitions>(x => x.SubscriptionId == subscriptionTest.SubscriptionId && x.TenantId == subscriptionTest.Inner.TenantId), It.IsAny<CancellationToken>()), Times.Once);
        }
    }
}
