...
namespace CCOInsights.SubscriptionManager.UnitTests
{
    public class BlueprintAssignmentUpdaterTests
    {
        ...
        public async Task BlueprintAssignmentUpdater_UpdateAsync_ShouldUpdate_IfValid()
        {
            ...
            _storageMock.Verify(x => x.UpdateItemAsync(It.IsAny<string>(), It.Is<BlueprintAssignments>(x => x.SubscriptionId == subscriptionTest.SubscriptionId && x.TenantId == subscriptionTest.Inner.TenantId), It.IsAny<CancellationToken>()), Times.Once);
        }
    }
}
