...
public class RoleAssignmentUpdaterTests
{
    ...
    public RoleAssignmentUpdaterTests()
    {
        ...
        _updater = new RoleAssignmentUpdater(_roleAssignmentProviderMock.Object, _usersProviderMock.Object, _storageMock.Object, _loggerMock.Object);
    }
    ...
    public async Task RoleAssignmentUpdater_UpdateAsync_ShouldUpdate_IfValid()
    {
        ...
        _storageMock.Verify(x => x.UpdateItemAsync(It.IsAny<string>(), It.IsAny<string>(), It.Is<RoleAssignment>(x => x.SubscriptionId == subscriptionTest.SubscriptionId && x.TenantId == subscriptionTest.Inner.TenantId), It.IsAny<CancellationToken>()), Times.Once);
    }
}
