...
namespace CCOInsights.SubscriptionManager.UnitTests
{
    public class VirtualMachineUpdaterTests
    {
        ...
        public async Task VirtualMachineUpdater_UpdateAsync_ShouldUpdate_IfValid()
        {
            ...
            _storageMock.Verify(x => x.UpdateItemAsync(It.IsAny<string>(), It.Is<VirtualMachine>(x => x.SubscriptionId == subscriptionTest.SubscriptionId && x.TenantId == subscriptionTest.Inner.TenantId), It.IsAny<CancellationToken>()), Times.Once);
        }
    }
}
