...
namespace CCOInsights.SubscriptionManager.UnitTests
{
    public class DefenderAssessmentMetadataUpdaterTests
    {
        ...
        public async Task DefenderAssessmentMetadataUpdater_UpdateAsync_ShouldUpdate_IfValid()
        {
            ...
            _storageMock.Verify(x => x.UpdateItemAsync(It.IsAny<string>(), It.Is<DefenderAssessmentsMetadata>(x => x.SubscriptionId == subscriptionTest.SubscriptionId && x.TenantId == subscriptionTest.Inner.TenantId), It.IsAny<CancellationToken>()), Times.Once);
        }
    }
}
