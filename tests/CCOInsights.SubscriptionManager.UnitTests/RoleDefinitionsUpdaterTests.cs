...
namespace CCOInsights.SubscriptionManager.UnitTests
{
    ...
    public class RoleDefinitionsUpdaterTests
    {
        ...
        public async Task SubAssessmentUpdater_UpdateAsync_ShouldUpdate_IfValid()
        {
            ...
            _storageMock.Verify(x => x.UpdateItemAsync(It.IsAny<string>(), It.Is<RoleDefinitions>(x => x.SubscriptionId == subscriptionTest.SubscriptionId && x.TenantId == subscriptionTest.Inner.TenantId), It.IsAny<CancellationToken>()), Times.Once);
        }
    }
}
