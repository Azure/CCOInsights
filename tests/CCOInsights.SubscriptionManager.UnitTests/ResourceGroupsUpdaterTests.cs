...
namespace CCOInsights.SubscriptionManager.UnitTests
{
    public class ResourceGroupsUpdaterTests
    {
        ...
        public async Task ResourceGroupUpdater_UpdateAsync_ShouldUpdate_IfValid()
        {
            ...
            _storageMock.Verify(x => x.UpdateItemAsync(It.IsAny<string>(), It.Is<ResourceGroup>(x => x.SubscriptionId == subscriptionTest.SubscriptionId && x.TenantId == subscriptionTest.Inner.TenantId), It.IsAny<CancellationToken>()), Times.Once);
        }
    }
}
